...
layui.define(function(exports){
    ...
    var disaster = {
        ...
        "color": function(option, bg) {
            ...
            if(!isNaN(obj)){
                if(obj == 0) return bg == undefined || bg == "" || bg == null ? "红色" : "<span class='ocpp-btn-tips ocpp-red'>红色</span>";
                if(obj == 1) return bg == undefined || bg == "" || bg == null ? "橙色" : "<span class='ocpp-btn-tips ocpp-orange'>橙色</span>";
                if(obj == 2) return bg == undefined || bg == "" || bg == null ? "黄色" : "<span class='ocpp-btn-tips ocpp-yellow'>黄色</span>";
                if(obj == 3) return bg == undefined || bg == "" || bg == null ? "蓝色" : "<span class='ocpp-btn-tips ocpp-blue'>蓝色</span>";
            }else{
                if(obj == '红色') return 0;
                if(obj == '橙色') return 1;
                if(obj == '黄色') return 2;
