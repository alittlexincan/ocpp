package com.zxyt.ocpp.publish.config.core.mvc;
...
import com.zxyt.ocpp.publish.config.common.result.ResultCode;
...
public class WebMvcConfig extends WebMvcConfigurationSupport {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/**").addResourceLocations("file:D:/ocpp/file/");
    }
    ...
    private ResultObject<Object> getResuleByHeandleException(HttpServletRequest request, Object handler, Exception e){
        ...
        result.setCode(ResultCode.INTERNAL_SERVER_ERROR).setMsg("接口 [" + request.getRequestURI() + "] 内部错误，请联系开发人员");
        String message;
