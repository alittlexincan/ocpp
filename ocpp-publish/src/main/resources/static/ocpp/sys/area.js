...
layui.use(["table","form","laytpl","layer","selectTree"], function(){
    ...
    let levelFormat = function(d){
        if(d.level == 0) return "<span class='layui-btn layui-btn-danger layui-btn-xs ocpp-cursor-default'>国家级</span>";
        if(d.level == 1) return "<span class='layui-btn layui-btn-warm layui-btn-xs ocpp-cursor-default'>省级</span>";
        if(d.level == 2) return "<span class='layui-btn layui-btn-normal layui-btn-xs ocpp-cursor-default'>市级</span>";
        if(d.level == 3) return "<span class='layui-btn layui-btn-xs ocpp-cursor-default'>县级</span>";
        if(d.level == 4) return "<span class='layui-btn layui-btn-disabled layui-btn-xs ocpp-cursor-default'>乡镇级</span>";
    };
